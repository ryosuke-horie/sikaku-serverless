...
export class InfraStack extends Stack {
	constructor(scope: Construct, id: string, props?: StackProps) {
		...
		// S3バケットを作成する
		const sikakuServerlessS3Bucket = new aws_s3.Bucket(this, "sikakuServerlessS3Bucket", {
		...
		sikakuServerlessS3Bucket.addToResourcePolicy(sikakuServerlessS3BucketPolicyStatement);
